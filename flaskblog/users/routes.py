...
from flaskblog.users.forms import RegistrationForm,LoginForm,Update,RequestResetForm,ResetpasswordForm
...
def reset_token():
    ...
    if user is None:
        flash('That token has been expired or invalid','warning')
